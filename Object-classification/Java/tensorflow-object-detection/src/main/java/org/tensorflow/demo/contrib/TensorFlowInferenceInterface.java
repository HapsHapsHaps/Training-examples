...
public class TensorFlowInferenceInterface {
    private final static Logger log = LoggerFactory.getLogger(TensorFlowInferenceInterface.class);
...
//  }
    ...
    public TensorFlowInferenceInterface(InputStream is) {
        ...
        try {
//      if (VERSION.SDK_INT >= 18) {
            log.debug("initializeTensorFlow");
            log.debug("readGraphDef");
//      }
...
//      }
            ...
            loadGraph(graphDef, g);
            log.info(TAG, "Successfully loaded model from the input stream");
